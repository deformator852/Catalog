...
@section('content')
    <div x-data="ComponentsFabric.getProductPriceAndCategoryFilterComponent()" x-init="init()">
    ...
    {{--    <div x-data="ComponentsFabric.getProductCategoryFilterComponent()" x-init="categoryFilter()">--}}
    {{--        <div class="products-filter">--}}
    {{--            <form @submit.prevent>--}}
    {{--                <select name="category" x-model="selectedCategory" @change="categoryFilter"--}}
    {{--                        class="products-filter__select">--}}
    {{--                    <option value="">All categories</option>--}}
    {{--                    @foreach($categories as $category)--}}
    ...
    {{--            </form>--}}
    {{--        </div>--}}
    {{--        <div x-data="ComponentsFabric.getProductPriceFilterComponent()">--}}
    {{--            <div class="price-filter">--}}
    {{--                <label>--}}
    {{--                    Min Price:--}}
    {{--                    <input type="number" min="0" step="0.01" x-model.number="priceMin" @change="emitPriceChange"--}}
    {{--                           class="price-filter__input" placeholder="0">--}}
    {{--                </label>--}}
    {{--                <label>--}}
    {{--                    Max Price:--}}
    {{--                    <input type="number" min="0" step="0.01" x-model.number="priceMax" @change="emitPriceChange"--}}
    {{--                           class="price-filter__input" placeholder="10000">--}}
    {{--                </label>--}}
    {{--            </div>--}}
    {{--        </div>--}}
